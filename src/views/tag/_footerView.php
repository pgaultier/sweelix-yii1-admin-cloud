...
<tr>
	<th colspan="6">
		<?php if($currentPage > 0) echo Html::link('<', array($route, 'tagId' => $tagId, 'page' => $previousPage), array('class' => 'button small'));?>
		...
		<?php endif;?>
		<?php if($currentPage < ($widget->dataProvider->pagination->pageCount-1)) echo Html::link('>', array($route, 'tagId' => $tagId, 'page' => $nexPage), array('class' => 'button small'));?>
	</th>
</tr>
